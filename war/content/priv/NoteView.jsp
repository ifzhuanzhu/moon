...
function prePage() {
	...
	i > 1 ? i-- : 1;
	location.href = "/priv/NoteView.do?pageIndex=" + i;
}
function nextPage() {
	var i = document.getElementById("pageIndex").value;
...
<body>
	...
	<div class="ContentLayOut">
		<div class="Header" style="margin-bottom: 20px;">
			<b>My Notes:</b>&nbsp;&nbsp;<a href="/priv/NoteEdit.do" style="float: right; margin-right: 50px;">Write a note.</a>
			<hr/>
		</div>
		<ul id="NoteList">
		<s:iterator value="noteList" id="note">
			<li>
				<div class="DivTitle"><a href="/priv/Note.do?id=${id}"><s:property value="title"/></a></div>
